      ...
      <div className="grid gap-4 sm:grid-cols-4">
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="mt-1 text-2xl font-bold">{account.balance.toFixed(2)} ARI</p>
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="mt-1 text-2xl font-bold">{totalEarned.toFixed(2)} ARI</p>
          </CardContent>
        </Card>
      </div>
              ...
              {operations.map((op) => (
                <li key={op.id} className="flex items-center justify-between text-sm">
                  ...
                  <span className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-brand">+{op.amount.toFixed(2)} ARI</span>
                  </span>
                </li>
              ))}
            </ul>
